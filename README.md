...
## [Settings](https://github.com/KimochiYamate/paws/blob/master/.env-example/)
...
## Installation
You can download the [**repository**](https://github.com/KimochiYamate/paws) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/KimochiYamate/paws
cd paws
```
